...
Determine the type of files you want to load (here with defaults)
```{r}
...
tmpFile <- paste0(files(filesToDelete)$fileName, "_TMP")
file.copy(files(filesToDelete)$fileName, tmpFile)
```
